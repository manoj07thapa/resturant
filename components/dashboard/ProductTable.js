		...
		<Fragment>
			<Disclosure className="">
				{({ open }) => (
					<div className="">
						<div className="px-2">
							<Disclosure.Button className=" rounded-md  flex justify-between w-full px-4 py-2 text-sm font-medium text-left text-white bg-purple-400  focus:outline-none ">
								<span className="text-lg font-medium ">Product Table</span>
								<svg
							...
							<Disclosure.Panel className=" px-4 pt-4 pb-2 text-sm text-gray-500 ">
								<div className="flex flex-col space-y-1 border-l-4 border-dashed border-purple-400 divide-y divide-purple-100">
									<Link
										href={{
											pathname: '/dashboard',
											query: { query: 'product-list' }
										}}
									>
										<a
											className={`${query === 'product-list'
