    ...
    return (
        <div className="lg:fixed bg-gray-100 h-80 xl:h-96 px-4 py-6 lg:w-80 xl:w-96 ">
            ...
            <button onClick={() => {
                ...
                className="px-4 py-2 mt-7 bg-green-900 hover:bg-green-700 rounded-md shadow text-white text-center w-full uppercase tracking-wide text-medium">Proceed to payment</button>
